...
def user_wallet(request):
    ...
    credit_transactions = Transaction.objects.filter(wallet = wallet,transaction_type = 'credit')
    debit_transactions = Transaction.objects.filter(wallet = wallet,transaction_type = 'debit')
